module.exports = nativeDescription: "繁體中文", englishDescription: "Chinese (Traditional)", translation:
  home:
    ...
    play_campaign_version: "開始戰役模式" # Shows up under big play button if you only play /courses
...
#  new_home:
    ...
    im_a_student: "我是學生"
    learn_more: "了解更多"
    classroom_in_a_box: "教授計算機科學的一站式課堂。"
    codecombat_is: "CodeCombat是一個讓<strong>學生們</strong>通過玩好玩的遊戲來學習計算機科學的平台。"
    our_courses: "我們的課程經過特殊測驗，<strong>在課堂上出類拔萃</strong>，即使教師幾乎沒有編程經驗。"
    top_screenshots_hint: "學生編寫代碼時，可即時查看改動"
    designed_with: "為老師而設"
...
#    setup_a_class: "Set Up a Class"
    have_an_account: "你有戶口嗎？"
    log_in: "登入"
    logged_in_as: "你目前以此身分登入"
...
#    jobs_subtitle: "Don't see a good fit but interested in keeping in touch? See our \"Create Your Own\" listing."
    jobs_benefits: "員工福利"
    jobs_benefit_1: "有競爭力的薪酬和期權"
    jobs_benefit_2: "15天最低休假政策，不包括公司的假期"
...
#    logged_in_as: "Logged in as:"
    not_you: "這不是你？"
    welcome_back: "冒險家你好，歡迎回來！"
    continue_playing: "繼續遊戲"
    more_options: "更多選項："
    option1_header: "選項1：透過電郵邀請學生們"
    option1_body: "自動發電郵給學生們，邀請他們參加這個課，他們需要以用戶名和密碼創建一個帳號。"
    option2_header: "選項2：發送 URL 鏈接給你的學生們"
    option2_body: "學生們會被要求輸入電郵地址、用戶名和密碼，以創建一個帳號。"
    option3_header: "選項3: 引導學生們到 codecombat.com/courses"
    option3_body: "給予學生們以下的驗證碼。他們創建新帳號時，電郵地址、用戶名、密碼和這個驗證碼一同輸入。"
...
#    play_level: "Play Level"
    ...
    print_guide: "打印指南 (PDF)"
    view_guide_online: "線上查閱指南 (PDF)"
...
#    language_cannot_change: "Language cannot be changed once students join a class."
    learn_p: "學習 Python"
    learn_j: "學習 JavaScript"
    avg_student_exp_label: "學生平均的編程經驗"
...
#    avg_student_exp_select: "Select the best option"
    avg_student_exp_none: "沒經驗 - 沒有或少許經驗"
    avg_student_exp_beginner: "初階 - 剛開始學或略懂block－based"
    avg_student_exp_intermediate: "中階 - 對寫程序代碼有些經驗"
    avg_student_exp_advanced: "高階 - 寫程序代碼的經驗相當豐富"
#    avg_student_exp_varied: "Varied Levels of Experience"
    student_age_range_label: "學生的年齡段"
    student_age_range_younger: "6歲以下"
    student_age_range_older: "超過18歲"
#    student_age_range_to: "to"
    create_class: "創建課堂"
#    class_name: "Class Name"
    teacher_account_restricted: "您的帳號屬於教師帳號, 所以無權訪問學生內容。"
...
#    connection_failure_desc: "It doesn’t look like you’re connected to the internet! Check your network connection and then reload this page."
    ...
    login_required_desc: "訪問此頁面前請先登入。"
...
#    forbidden_desc: "Oh no, there’s nothing we can show you here! Make sure you’re logged into the correct account, or visit one of the links below to get back to programming!"
    not_found: "沒找到。"
    not_found_desc: "呃～ 這裡什麼都沒有. 訪問以下的其中一個鏈接以繼續學習編程！"
    not_allowed: "方法不被允許。"
    ...
    unknown: "未知錯誤。" # {change}
    error: "錯誤"
    general_desc: "出了點問題，或許是我們的錯。請稍後再嘗試刷新頁面，或訪問以下的其中一個鏈接以繼續學習編程！"
